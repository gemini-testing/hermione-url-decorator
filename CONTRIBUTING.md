...
All bug fixes and new features should go to the [`master`](https://github.com/gemini-testing/hermione-url-decorator/tree/master) branch.
...
1. [Search](https://github.com/gemini-testing/hermione-url-decorator/issues) for same issues on github in order to prevent duplicates
